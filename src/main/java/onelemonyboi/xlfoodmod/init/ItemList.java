...
public class ItemList {
	...
	public static Item SEAWEED = new Items("seaweed");
	public static Item BOWL = new Items("bowl");
	public static Item COFFEE_CUP = new Items("coffee_cup");
	public static Item GLASS_MUG = new Items("glass_mug");
	public static Item CHOCOLATE_ICE_CREAM_BALL = new Items("chocolate_ice_cream_ball");
	public static Item VANILLA_ICE_CREAM_BALL = new Items("vanilla_ice_cream_ball");
	public static Item STRAWBERRY_ICE_CREAM_BALL = new Items("strawberry_ice_cream_ball");
	public static Item TOMATO_SAUCE = new Items("tomato_sauce");
	public static Item HOT_SAUCE = new Items("hot_sauce");
	public static Item CHOCOLATE_SYRUP = new Items("chocolate_syrup");
	public static Item VANILLA_EXTRACT = new Items("vanilla_extract");
	public static Item VANILLA_CREAM = new Items("vanilla_cream");
	public static Item EMPTY_CAN = new Items("empty_can");
	public static Item PIE_SHELL = new Items("pie_shell");
	public static Item PAPER_CUP = new Items("paper_cup");
	...
	public static Item LEMON_JUICE = new JuiceItem("lemon_juice", 2, 0.2F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item STRAWBERRY_JUICE = new JuiceItem("strawberry_juice", 2, 0.2F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item PINEAPPLE_JUICE = new JuiceItem("pineapple_juice", 2, 0.2F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item LEMON_SYRUP = new JuiceItem("lemon_syrup", 2, 0.2F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item STRAWBERRY_SYRUP = new JuiceItem("strawberry_syrup", 2, 0.2F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item PINEAPPLE_SYRUP = new JuiceItem("pineapple_syrup", 2, 0.2F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item LEMON_SLUSHIE = new JuiceItem("lemon_slushie", 3, 0.4F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item STRAWBERRY_SLUSHIE = new JuiceItem("strawberry_slushie", 3, 0.4F, net.minecraft.world.item.Items.GLASS_BOTTLE);
	public static Item PINEAPPLE_SLUSHIE = new JuiceItem("pineapple_slushie", 3, 0.4F, net.minecraft.world.item.Items.GLASS_BOTTLE);
