...
import onelemonyboi.xlfoodmod.items.BeerItem;
import onelemonyboi.xlfoodmod.items.BowlItem;
import onelemonyboi.xlfoodmod.items.BucketOfFriedChickenItem;
import onelemonyboi.xlfoodmod.items.CappucinoItem;
import onelemonyboi.xlfoodmod.items.CoffeeItem;
import onelemonyboi.xlfoodmod.items.DeadlyEnergyDrinkItem;
import onelemonyboi.xlfoodmod.items.HealthyEnergyDrinkItem;
import onelemonyboi.xlfoodmod.items.SpeedyEnergyDrinkItem;
import onelemonyboi.xlfoodmod.items.StealthyEnergyDrinkItem;
import onelemonyboi.xlfoodmod.items.StrongEnergyDrinkItem;
import onelemonyboi.xlfoodmod.items.SuperEnergyDrinkItem;

public class ItemList {
	
	public static net.minecraft.item.BlockItem ROCK_SALT = new BlockItems(BlockList.ROCK_SALT);
	public static net.minecraft.item.BlockItem GRASS = new BlockItems(BlockList.GRASS);
	...
	public static net.minecraft.item.Item SUPER_ENERGY_DRINK = new SuperEnergyDrinkItem("super_energy_drink", 0, 0.0F);
	public static net.minecraft.item.Item GLASS_MUG = new Items("glass_mug");
	public static net.minecraft.item.Item BEER = new BeerItem("beer", 1, 0.2F);
	public static net.minecraft.item.Item COFFEE_CUP = new Items("coffee_cup");
	public static net.minecraft.item.Item COFFEE = new CoffeeItem("coffee", 1, 0.2F);
	public static net.minecraft.item.Item CAPPUCCINO = new CappucinoItem("cappuccino", 2, 0.2F);
